  ...
  return <section className="w-full bg-gradient-to-br from-[#f4d58d] to-[#ffde7d] relative overflow-hidden min-h-[600px] flex items-center">
      <div className="container mx-auto px-4 md:px-8 py-16 md:py-20 flex flex-col md:flex-row items-center gap-8 md:gap-16">
        <div className="md:w-1/2 z-10">
          ...
          <button className="bg-black text-white px-8 py-3 rounded-lg hover:bg-gray-800 transition-all duration-300 font-bold text-sm shadow-xl">
            Beli Sekarang
          </button>
        </div>
        <div className="md:w-1/2 relative flex justify-center">
          <div className="relative">
            <img src="https://images.unsplash.com/photo-1587049352846-4a222e784d38?w=500&h=600&fit=crop" alt="Madu dengan sendok madu menetes" className="w-full max-w-md h-auto object-contain drop-shadow-2xl" />
          </div>
        </div>
      </div>
    </section>;
