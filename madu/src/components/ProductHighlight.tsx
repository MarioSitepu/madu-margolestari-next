        ...
        <div className="relative max-w-[1440px] mx-auto h-auto md:h-[786px] overflow-visible py-8 sm:py-10 md:py-0 px-4 sm:px-6 md:px-0 flex flex-col md:block">
          ...
          <div className="flex flex-col md:hidden w-full gap-6 sm:gap-8">
            ...
            <div className="relative text-white mx-auto px-0 text-center w-full max-w-full sm:max-w-lg z-10 animate-fade-in-right">
              ...
              >
                Madu Hutan Premium kami adalah produk best seller yang telah
                memikat hati pelanggan setia kami. Dipanen langsung dari hutan
                alami, madu ini mengandung berbagai nektar bunga pilihan yang
                memberikan rasa khas dan manfaat luar biasa. Setiap tetesnya
                kaya akan nutrisi dan antioksidan alami yang dapat mendukung
                daya tahan tubuh dan meningkatkan kesehatan secara keseluruhan.
              </p>
            </div>
              ...
              >
                ...
                >
                  ...
                  <img
                    ...
                    alt={`Botol Madu Murni ${product.name} Asli Lampung dari Madu Jaya Lestari - Produk Best Seller Madu Berkualitas Tinggi`}
          ...
          >
            ...
            >
              ...
              memikat hati pelanggan setia kami. Dipanen langsung dari hutan
              alami, madu ini mengandung berbagai nektar bunga pilihan yang
              memberikan rasa khas dan manfaat luar biasa. Setiap tetesnya kaya
              akan nutrisi dan antioksidan alami yang dapat mendukung daya tahan
              tubuh dan meningkatkan kesehatan secara keseluruhan.
            </p>
          </div>
          ...
          >
            <div className="relative w-full h-full">
              <img
                src={honeyBg}
                alt="Background tetesan madu alami dari peternakan lebah Madu Jaya Lestari Lampung"
                className="w-full h-full object-cover object-[100%_center] transition-transform duration-700 hover:scale-110"
              />
