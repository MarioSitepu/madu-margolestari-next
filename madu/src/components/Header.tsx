      ...
      <div className="relative w-full max-w-[1440px] mx-auto px-4 sm:px-6 md:px-0">
        ...
        >
          ...
          >
            ...
            >
              Rasakan Madu Asli <br className="hidden sm:block" />
              Dari {/* Sumbernya dengan underline - positioned inline */}
              <span
          ...
          >
            {[
              "Selamat datang di Madu Jaya Lestari tempat ini,",
              "keaslian dan kualitas bertemu Kami bangga mempersembahkan,",
              "madu seratus persen asli dipanen dari peternakan alam,",
              "lebah alami tanpa campuran bahan apapun untuk Setiap,",
              "tetes madu kami adalah hasil dari alam yang murni,",
              "murni yang diproses dengan hati-hati untuk menjaga baik.",
            ].map((word, index) => (
              <span
                key={index}
