  ...
  return (
    <section className="w-full bg-white py-0 relative">
      <div className="relative w-full h-[400px] sm:h-[500px] md:h-[600px]">
        <img
          src={headerImage}
          alt="Dokumentasi peternak lebah Madu Jaya Lestari memeriksa sarang lebah di Jati Agung Lampung Selatan - Proses produksi madu murni berkualitas"
          ...
          <div className="container mx-auto px-4 sm:px-6 md:px-8">
            <div className="max-w-xl">
              <h2 className="text-[28px] sm:text-4xl md:text-5xl lg:text-6xl font-black mb-6 sm:mb-8 leading-tight text-white">
                ...
                Pengerjaan Dan
                <br />
                Artikel <span className="text-[#ffde7d]">Kami</span>
              </h2>
