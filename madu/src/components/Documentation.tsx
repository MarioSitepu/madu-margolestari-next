...
export function Documentation() {
  return <section className="w-full bg-white py-0 relative">
      <div className="relative w-full h-[400px] sm:h-[500px] md:h-[600px]">
        <img src={headerImage} alt="Dokumentasi peternak lebah Madu Jaya Lestari memeriksa sarang lebah di Jati Agung Lampung Selatan - Proses produksi madu murni berkualitas" className="w-full h-full object-cover" />
