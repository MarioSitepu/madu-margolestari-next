...
export function ArticleCard({ article }: ArticleCardProps) {
  ...
  return (
    <div className="relative aspect-square bg-[#00b8a9] border-[6px] border-white rounded-xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
