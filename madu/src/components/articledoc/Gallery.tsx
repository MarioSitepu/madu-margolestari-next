                ...
                >
                  <div className="bg-[#ffde7d] p-3 rounded-xl shadow-2xl">
                    <div className="bg-white p-3 rounded-lg">
                      <img
                        src={image}
                        alt={`Galeri foto dokumentasi madu dan peternakan lebah Madu Jaya Lestari - Gambar ${startIndex + index + 1}`}
        ...
        >
          ...
          >
            <img
              ...
              alt={`Galeri foto dokumentasi madu dan peternakan lebah Madu Jaya Lestari - Lightbox gambar ${lightboxIndex + 1}`}
