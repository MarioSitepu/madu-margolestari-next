            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
              ...
              <div className="text-center lg:text-left max-w-xl">
                <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2" style={{ fontFamily: 'Nort, sans-serif' }}>
                  Dapatkan Info & <span className="text-[#00b8a9]">Promo Spesial</span>
                </h2>
                <p className="text-gray-600">
                  Berlangganan newsletter dan dapatkan <span className="font-bold text-[#e5c15d]">Voucher 20%</span> untuk pembelian pertama.
                </p>
              </div>
