...
export function InfoSection() {
  return (
    <section className="w-full bg-[#00B8A9] relative overflow-hidden py-16 md:py-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2 text-white space-y-8 text-center lg:text-left order-2 lg:order-1">
            
            {/* Header Title */}
            <div>
              <div className="flex items-center justify-center lg:justify-start gap-3 mb-4">
                <HelpCircle className="w-8 h-8 text-[#FFDE7D]" />
                <span className="text-[#FFDE7D] font-bold tracking-wider uppercase text-sm">Edukasi Madu</span>
              </div>
