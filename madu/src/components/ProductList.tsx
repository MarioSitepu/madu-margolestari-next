...
const products = [
  {
    ...
    name: "Lebah Cerana",
    description:
      "Madu asli dari lebah Cerana yang dibudidayakan dengan sangat hati-hati. Dengan rasa manis yang pas dan tekstur yang kental, madu ini adalah pilihan yang tepat untuk Anda.",
    price: 50000,
...
export function ProductList() {
  return (
    <section className="w-full bg-[#ffde7d] py-12 sm:py-16 md:py-20">
          ...
          {products.map((product) => {
            ...
            return (
              ...
              >
                ...
                <div className="relative flex-1 flex items-center justify-center pt-6 sm:pt-8 md:pt-[38px] pb-4 sm:pb-6 md:pb-0 min-h-[200px] sm:min-h-[250px] md:min-h-[380px]">
                  <div className="relative w-[120px] h-[180px] sm:w-[140px] sm:h-[220px] md:w-[165px] md:h-[380px]">
                    <img
                      ...
                      alt={`Botol Madu Murni ${product.name} Asli Lampung dari Madu Jaya Lestari - Produk Madu Berkualitas Tinggi`}
                ...
                <div className="px-6 sm:px-6 md:px-[24px] pb-4 sm:pb-8 md:pb-6 space-y-3 sm:space-y-4 md:space-y-0">
                  {/* Product Name */}
