      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <button
              onClick={() => navigate('/')}
              className="flex items-center gap-3 p-4 bg-gradient-to-r from-[#00b8a9] to-[#00a298] text-white rounded-lg hover:shadow-lg transition-all font-semibold"
            >
            ...
            <button
              ...
              className="flex items-center gap-3 p-4 bg-gradient-to-r from-[#ffde7d] to-[#f4d58d] text-gray-900 rounded-lg hover:shadow-lg transition-all font-semibold"
            >
