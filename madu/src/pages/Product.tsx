                ...
                return (
                  ...
                  >
                    ...
                    <div className="absolute top-[421px] left-6 right-6 h-8 flex items-center justify-start">
                      <Link to={`/product/${product._id}`} className="hover:opacity-80 transition-opacity">
                        <h3
                          className="text-[24px] font-medium text-[#ffde7d] leading-[1.342] text-left whitespace-nowrap cursor-pointer"
                          style={{ fontFamily: 'Nort, sans-serif' }}
                        >
