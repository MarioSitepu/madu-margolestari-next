    ...
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-[#ffde7d] to-[#00b8a9] py-8 px-4">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex items-center gap-4 mb-8">
          ...
          <h1 className="text-4xl font-black text-white drop-shadow-lg" style={{ fontFamily: 'Nort, sans-serif' }}>Kelola Komentar</h1>
        </div>

        <Card className="p-6 bg-white/95 backdrop-blur-sm border-2 border-white/50 shadow-2xl">
          <div className="mb-4">
            <p className="text-gray-600" style={{ fontFamily: 'Nort, sans-serif' }}>Total Komentar: <span className="font-bold text-[#00b8a9]">{comments.length}</span></p>
          </div>
          {comments.length === 0 ? (
            ...
            <div className="space-y-4">
              {comments.map((comment) => (
                <div key={comment._id} className="flex items-start justify-between p-4 border-2 border-gray-200/50 rounded-lg hover:bg-white/80 hover:shadow-md transition-all duration-300 bg-white/60 backdrop-blur-sm">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="font-semibold text-gray-900" style={{ fontFamily: 'Nort, sans-serif' }}>{comment.authorName}</span>
